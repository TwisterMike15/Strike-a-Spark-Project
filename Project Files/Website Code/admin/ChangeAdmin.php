...
<html>
	...
	<body class="background">
		<center>
			...
			<form action ="./admin_security/changepass_redirect.php" method="POST" onsubmit="return true;">
				<p>Enter current admin password. </p>
				<input id="Oldpassword" placeholder="Old Password" type="text" size="30" name="Old-Admin-Pass" required><br>
				<p> Enter new admin password. </p>
				<input id="Newpassword" placeholder="New Password" type="text" size="30" name="New-Admin-Pass" required><br>
				<br>
	...
	{
		var check = false;
		check = confirm("Admin Password change is final. Press OK to confirm submission");
		return check;
	}
	</script>
</html>
